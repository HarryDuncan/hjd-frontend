...
import {
  MarchingCubes,
  Mirror,
} from "visuals/components/three-js-components/components";
import { Text } from "visuals/components/three-js-components/components/Text";
import {
  COMPONENT_TYPES,
  MarchingCubesProps,
  MirrorProps,
    ...
    return componentConfigs.flatMap(({ componentType, componentProps }) => {
      switch (componentType) {
        ...
        case COMPONENT_TYPES.TEXT: {
          const { name, fontUrl, text, materialProps, position } =
