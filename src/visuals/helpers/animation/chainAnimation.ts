import { AnimationFunctionProps } from "visuals/components/animation-manager/animationManager.types";
import { getMeshesByIdentifier } from "visuals/helpers/scene/getMeshesByIdentifier";
import { degreesToEuler } from "visuals/helpers/three-dimension-space/degreesToEuler";
import { easeOut } from "visuals/utils";
import { stepAndWrap } from "visuals/utils/stepAndWrap";
import {
  AnimationProperties,
  ANIMATION_TYPES,
