...
import InteractiveMaterial from "visuals/components/interactive-shaders/interactive-raw-shader/InteractiveRawShader";
...
export enum INTERACTIVE_SHADER_TYPES {
